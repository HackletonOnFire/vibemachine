-- Drop and recreate get_energy_summary function
-- This fixes the return type conflict

-- First, drop the existing function
DROP FUNCTION IF EXISTS public.get_energy_summary(UUID, DATE, INTEGER);
...
DO $$
BEGIN
    RAISE NOTICE 'get_energy_summary function created successfully!';
END $$; 